    ...
    <div class="row">
        <div class=" col-xl-9 col-sm-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/member/mypage/admin/individual_accounting/">個別会計</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ログ</li>
                </ol>
            </nav>
            <?php
            //$log = file_get_contents("../core/logs.log");
            $filename = "/home/chorkleines/www/member/mypage/Core/individual_accounting.log";
            $lines = file($filename);
