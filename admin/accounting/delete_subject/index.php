        ...
        <div class=" col-xl-9 col-sm-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">集金対象者の削除</li>
                </ol>
            </nav>
            <p>削除したい集金対象者を選択してください。<br>既に支払いが済んでいる集金対象者は削除できません。</p>
            <form method="post" action="./delete_subject.php" name="form" class="mb-4">
                ...
                <button type="submit" class="btn btn-danger" name="submit">集金対象から削除</button>
